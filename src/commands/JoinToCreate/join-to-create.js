    ...
    try {
        ...
        if (!message || typeof message.createMessageComponentCollector !== 'function') {
            throw new TitanBotError(
                ...
                ErrorTypes.DISCORD_API,
                'Failed to open configuration controls. Please run `/join-to-create dashboard` again.'
            );
        }
